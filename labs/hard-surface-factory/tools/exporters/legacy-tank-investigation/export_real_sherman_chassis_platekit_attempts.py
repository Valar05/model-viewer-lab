...
ATTEMPTS = [
    {'suffix': 'a01', 'label': 'topology first rough plate kit', 'spacing': 0.58, 'z_gap': 0.32, 'front_refine': 0.0, 'rear_refine': 0.0, 'socket_segments': 0, 'side_taper': 0.00, 'deck_cut': False, 'judgment': 'Expected to prove topology discipline before chasing silhouette.'},
    {'suffix': 'a02', 'label': 'angle and silhouette cleanup', 'spacing': 0.54, 'z_gap': 0.28, 'front_refine': 0.08, 'rear_refine': 0.06, 'socket_segments': 0, 'side_taper': 0.07, 'deck_cut': False, 'judgment': 'Fixes obvious slab posture: stronger glacis rake, side taper, rear wrap ownership.'},
    {'suffix': 'a03', 'label': 'preferred candidate with essential turret socket', 'spacing': 0.52, 'z_gap': 0.26, 'front_refine': 0.10, 'rear_refine': 0.08, 'socket_segments': 12, 'side_taper': 0.09, 'deck_cut': True, 'judgment': 'Preferred candidate: authored low-poly plates plus only the essential deck opening.'},
]
