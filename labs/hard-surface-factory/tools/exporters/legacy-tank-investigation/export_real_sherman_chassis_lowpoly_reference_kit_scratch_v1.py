...
ASSET_ID = 'real_sherman_chassis_lowpoly_reference_kit_scratch_v1'
REVISION = 'lowpoly-reference-kit-v1-planar-dissolve-flat-planes'
...
for idx, obj in enumerate(parts):
    ...
    if tris_after_planar > 6500:
        collapse = obj.modifiers.new('lowpoly_silhouette_guarded_collapse', 'DECIMATE')
        collapse.ratio = 6500 / max(tris_after_planar, 1)
...
manifest = {
    ...
    'policy': {
        ...
        'decimation': 'planar hard-surface dissolve first; broad flat source tessellation must collapse to low face counts before any silhouette-guarded collapse',
    },
