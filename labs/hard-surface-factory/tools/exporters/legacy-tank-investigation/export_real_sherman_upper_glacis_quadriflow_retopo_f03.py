...
ASSET_ID = 'real_sherman_upper_glacis_quadriflow_retopo_scratch_f03'
REVISION = 'f03-source-quadriflow-preserve-sharp-reto'
...
def make_quadriflow_retopo(source_obj, material):
    ...
    obj.name = ASSET_ID + '_upper_front_glacis_quadriflow_retopo'
    ...
    obj['primary_retopo_piece'] = True
    obj['authoring_policy'] = 'Blender Quadriflow retopo from the source component, preserving sharp and boundary features at target_faces=1200. Scratch diagnostic only.'
    obj.modifiers.new('weighted_normals_quadriflow_retopo', 'WEIGHTED_NORMAL')
    return obj
...
def main():
    ...
    landmarks = {
        'asset_id': ASSET_ID,
        'target_faces': 1200,
        'retopo_engine': 'bpy.ops.object.quadriflow_remesh',
        'preserve_sharp': True,
        'preserve_boundary': True,
        'source_component': ROLE,
        'lesson_from_f01_f02': 'f01 had good depth but ugly heightfield artifacts; f02 was clean but guessed feature placement. f03 preserves source feature topology directly.'
    }
    ...
    manifest = {
        ...
        'landmarks': {'path': str(landmarks_path.relative_to(ROOT)), 'target_faces': 1200},
    ...
    note = '# ' + ASSET_ID + '\n\nSource Quadriflow retopo pass. Scratch diagnostic only; not cloud accepted.\n\n- Source component: ' + ROLE + '\n- Stats: ' + str(stats) + '\n- Depth report: ' + str(depth_report) + '\n- Intended to escape f01/f02 ugliness by preserving source sharp/boundary features instead of rebuilding from guessed plates.\n'
