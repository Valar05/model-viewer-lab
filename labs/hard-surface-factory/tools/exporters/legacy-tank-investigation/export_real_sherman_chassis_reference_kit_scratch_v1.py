...
ASSET_ID = 'real_sherman_chassis_reference_kit_scratch_v1'
REVISION = 'reference-kit-v1-source-components-not-boxes'
...
for idx, obj in enumerate(parts):
    ...
    if tris_before > 16000:
        dec = obj.modifiers.new('reference_kit_conservative_decimate', 'DECIMATE')
        dec.ratio = 0.32
    ...
    manifest_parts.append({
        ...
        'triangles_before_decimate': tris_before,
        'triangles_after_decimate': tris_after,
...
manifest = {
    'asset_id': ASSET_ID,
    'artifact_type': 'scratch_reference_configuration_kit_from_source_mesh_components',
    'revision': REVISION,
    'scratch_mode': True,
