...
ASSET_ID = 'real_sherman_chassis_handretopo_referencekit_scratch_c01'
REVISION = 'hand-retopo-source-reference-parts-same-config-with-reference-sheet'
...
if REF_IMAGE.exists():
    ...
    verts=[(-1.35,1.10,-0.62),(1.35,1.10,-0.62),(1.35,1.10,0.72),(-1.35,1.10,0.72)]
    faces=[(0,1,2,3)]
...
bpy.ops.object.camera_add(location=(0,-3.35,0.72))
