...
ASSET_ID = 'real_sherman_chassis_handretopo_referencekit_scratch_c03'
REVISION = 'hand-retopo-source-reference-parts-same-config-readable-reference-sheet-c03-uv-fixed'
...
if REF_IMAGE.exists():
    ...
    uv_layer = mesh.uv_layers.new(name='reference_sheet_uv')
    # Explicit image UVs are required; without this Blender samples a single pale texel.
